...
import heroImageAsset from "@/assets/wanderwise-hero.jpg.asset.json";
import jaipurImageAsset from "@/assets/destination-jaipur.jpg.asset.json";
import goaImageAsset from "@/assets/destination-goa.jpg.asset.json";
import keralaImageAsset from "@/assets/destination-kerala.jpg.asset.json";
import kashmirImageAsset from "@/assets/destination-kashmir.jpg.asset.json";
...
const jaipurImage = jaipurImageAsset.url;
const goaImage = goaImageAsset.url;
const keralaImage = keralaImageAsset.url;
const kashmirImage = kashmirImageAsset.url;
  ...
  return (
    <main className="min-h-screen overflow-clip bg-background text-foreground">
      ...
      <section
        ref={heroRef}
        id="top"
        className={`hero-section ${isExplore ? "explore-hero" : "hero-home"}`}
        onPointerMove={(event) => {
      ...
      {isExplore && <section ref={resultsRef} id="results" className="mx-auto max-w-7xl scroll-mt-20 px-5 py-16 lg:px-8 lg:py-20">
        <Reveal>
